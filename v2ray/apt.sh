...
http_proxy_setting="Acquire::http::Proxy \"http://127.0.0.1:10809\";"
https_proxy_setting="Acquire::https::Proxy \"http://127.0.0.1:10809\";"
temp_file="/tmp/apt.conf.tmp"
...
main() {
    ...
    echo "请选择操作："
    echo "1. 将 V2Ray 代理端口添加到 apt 配置文件"
    echo "2. 从 apt 配置文件中删除 V2Ray 代理端口"
